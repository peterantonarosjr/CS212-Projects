...
public class CandleGUI extends JFrame{
	...
	private void createFileMenu() {
	    ...
	    FileMenuHandler fmh  = new FileMenuHandler(this,sCandles,uCandles,unsortedCandleList,sortedCandleList);
	    EditMenuHandler emh  = new EditMenuHandler(this,sCandles,uCandles,unsortedCandleList,sortedCandleList);
